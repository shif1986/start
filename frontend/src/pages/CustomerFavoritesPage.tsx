...
export default function CustomerFavoritesPage({ accountType = "customer" }: { accountType?: "customer" | "professional" }) {
  ...
  return (
    ...
    >
      {dataSource === "supabase" && favoritesQuery.isPending ? (
      ...
      ) : dataSource === "supabase" && favoritesQuery.isError ? (
