...
returns table (
  ...
  seller_display_name text, seller_company_name text, seller_username text,
  seller_avatar_url text, seller_bio text, seller_city text,
...
as $$
  select
    ...
    seller.display_name, seller.company_name, seller.username, seller.avatar_url,
    seller.bio, seller.city, seller.is_verified, contact.phone,
    contact.public_email, contact.postal_address,
    exists (
